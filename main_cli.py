...
print("Трафік багатоканальної системи:", round_2nd_digit(all_traffic))
print("Трафік системи на канал:", round_2nd_digit(channel_traffic))
print("Вірогідність затримки зв'язку Pc:", round_2nd_digit(chance_of_waiting))
print("Вірогідність відмови системи Pb:", round_2nd_digit(chance_of_blocking_pb))
print("Вірогідність відмови системи Pa:", round_2nd_digit(chance_of_blocking_pa))
